...
2026-09-10 更新：六张人物已改为真正 RGBA 透明素材（原图保留）；视频改为三张可放大截图；桌面加入缓冲转身和色卡联动。窄于701px使用完整纵向布局，并加入滚动渐入、人物轻微视差、阅读进度和触摸反馈；减少动态效果偏好保持静态。完整抠图输出保存在 ../素材/图片/透明人物，处理脚本在 ../tmp/matte_characters.py。参考视频已通过浏览器观察，使用其居中人物与色卡组合思路，并非逐帧复刻。
